...
/***************************************************************************************/
  // Generates a unique email from a given prefix, thecurrent timestamp, and a given domain
/***************************************************************************************/
  generateUniqueEmail : function (prefix) {
    var milis = new Date().getTime();
    return prefix + milis + "@auticon-testing.us";
  }
